...
public class NativeCamera_CameraStateListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DrawnUi.Camera.NativeCamera+CameraStateListener, DrawnUi.Maui.Camera", NativeCamera_CameraStateListener.class, __md_methods);
	}

	public NativeCamera_CameraStateListener ()
	{
		super ();
		if (getClass () == NativeCamera_CameraStateListener.class) {
			mono.android.TypeManager.Activate ("DrawnUi.Camera.NativeCamera+CameraStateListener, DrawnUi.Maui.Camera", "", this, new java.lang.Object[] {  });
		}
	}

	public NativeCamera_CameraStateListener (crc6451b7f263ad7a2be9.NativeCamera p0)
	{
		super ();
		if (getClass () == NativeCamera_CameraStateListener.class) {
			mono.android.TypeManager.Activate ("DrawnUi.Camera.NativeCamera+CameraStateListener, DrawnUi.Maui.Camera", "DrawnUi.Camera.NativeCamera, DrawnUi.Maui.Camera", this, new java.lang.Object[] { p0 });
		}
	}
