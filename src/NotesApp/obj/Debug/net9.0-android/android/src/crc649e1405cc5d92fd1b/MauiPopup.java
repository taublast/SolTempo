...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FastPopups.MauiPopup, FastPopups", MauiPopup.class, __md_methods);
	}
	...
	public MauiPopup (android.content.Context p0, boolean p1, android.content.DialogInterface.OnCancelListener p2)
	{
		...
		if (getClass () == MauiPopup.class) {
			mono.android.TypeManager.Activate ("FastPopups.MauiPopup, FastPopups", "Android.Content.Context, Mono.Android:System.Boolean, System.Private.CoreLib:Android.Content.IDialogInterfaceOnCancelListener, Mono.Android", this, new java.lang.Object[] { p0, p1, p2 });
		}
	}
	...
	public MauiPopup (android.content.Context p0, int p1)
	{
		super (p0, p1);
		if (getClass () == MauiPopup.class) {
			mono.android.TypeManager.Activate ("FastPopups.MauiPopup, FastPopups", "Android.Content.Context, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1 });
		}
	}
	...
	public MauiPopup (android.content.Context p0)
	{
		super (p0);
		if (getClass () == MauiPopup.class) {
			mono.android.TypeManager.Activate ("FastPopups.MauiPopup, FastPopups", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
