...
public class SkiaGLTextureView
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DrawnUi.SkiaGLTextureView, DrawnUi.Maui", SkiaGLTextureView.class, __md_methods);
	}

	public SkiaGLTextureView (android.content.Context p0, android.util.AttributeSet p1, int p2, int p3)
	{
		super (p0, p1, p2, p3);
		if (getClass () == SkiaGLTextureView.class) {
			mono.android.TypeManager.Activate ("DrawnUi.SkiaGLTextureView, DrawnUi.Maui", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2, p3 });
		}
	}

	public SkiaGLTextureView (android.content.Context p0, android.util.AttributeSet p1, int p2)
	{
		super (p0, p1, p2);
		if (getClass () == SkiaGLTextureView.class) {
			mono.android.TypeManager.Activate ("DrawnUi.SkiaGLTextureView, DrawnUi.Maui", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android:System.Int32, System.Private.CoreLib", this, new java.lang.Object[] { p0, p1, p2 });
		}
	}

	public SkiaGLTextureView (android.content.Context p0, android.util.AttributeSet p1)
	{
		super (p0, p1);
		if (getClass () == SkiaGLTextureView.class) {
			mono.android.TypeManager.Activate ("DrawnUi.SkiaGLTextureView, DrawnUi.Maui", "Android.Content.Context, Mono.Android:Android.Util.IAttributeSet, Mono.Android", this, new java.lang.Object[] { p0, p1 });
		}
	}

	public SkiaGLTextureView (android.content.Context p0)
	{
		super (p0);
		if (getClass () == SkiaGLTextureView.class) {
			mono.android.TypeManager.Activate ("DrawnUi.SkiaGLTextureView, DrawnUi.Maui", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
		}
	}
