...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onError:(Landroidx/media3/common/VideoFrameProcessingException;)V:GetOnError_Landroidx_media3_common_VideoFrameProcessingException_Handler:AndroidX.Media3.ExoPlayer.Video.PlaybackVideoGraphWrapper/IListener, Xamarin.AndroidX.Media3.ExoPlayer\n" +
			"n_onFirstFrameRendered:()V:GetOnFirstFrameRenderedHandler:AndroidX.Media3.ExoPlayer.Video.PlaybackVideoGraphWrapper/IListener, Xamarin.AndroidX.Media3.ExoPlayer\n" +
			"n_onFrameAvailableForRendering:()V:GetOnFrameAvailableForRenderingHandler:AndroidX.Media3.ExoPlayer.Video.PlaybackVideoGraphWrapper/IListener, Xamarin.AndroidX.Media3.ExoPlayer\n" +
			"n_onFrameDropped:()V:GetOnFrameDroppedHandler:AndroidX.Media3.ExoPlayer.Video.PlaybackVideoGraphWrapper/IListener, Xamarin.AndroidX.Media3.ExoPlayer\n" +
			"n_onVideoSizeChanged:(Landroidx/media3/common/VideoSize;)V:GetOnVideoSizeChanged_Landroidx_media3_common_VideoSize_Handler:AndroidX.Media3.ExoPlayer.Video.PlaybackVideoGraphWrapper/IListener, Xamarin.AndroidX.Media3.ExoPlayer\n" +
			"";
