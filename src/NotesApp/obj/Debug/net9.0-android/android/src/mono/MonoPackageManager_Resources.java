...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "NotesApp.dll" comes first in this list. */
		"NotesApp.dll",
		"FastPopups.dll",
		"AppoMobi.Maui.Gestures.dll",
		"AppoMobi.Maui.Native.Android.dll",
		"AppoMobi.Specials.dll",
		"CommonMark.dll",
		...
		"Xamarin.AndroidX.Media3.Effect.dll",
		"Xamarin.AndroidX.Media3.ExoPlayer.dll",
		"Xamarin.AndroidX.Media3.Extractor.dll",
		"Xamarin.AndroidX.Media3.Muxer.dll",
		"Xamarin.AndroidX.Media3.Transformer.dll",
