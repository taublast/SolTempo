...
public class SkiaEditor_MyTextWatcher
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("DrawnUi.Draw.SkiaEditor+MyTextWatcher, DrawnUi.Maui", SkiaEditor_MyTextWatcher.class, __md_methods);
	}

	public SkiaEditor_MyTextWatcher ()
	{
		super ();
		if (getClass () == SkiaEditor_MyTextWatcher.class) {
			mono.android.TypeManager.Activate ("DrawnUi.Draw.SkiaEditor+MyTextWatcher, DrawnUi.Maui", "", this, new java.lang.Object[] {  });
		}
	}
